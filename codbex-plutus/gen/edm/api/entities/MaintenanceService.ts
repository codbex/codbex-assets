...
import { MaintenanceRepository, MaintenanceEntityOptions } from "../../dao/entities/MaintenanceRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-plutus-entities-Maintenance", ["validate"]);
...
class MaintenanceService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-plutus/gen/edm/api/entities/MaintenanceService.ts/" + entity.Id);
