...
import { AssetRepository, AssetEntityOptions } from "../../dao/entities/AssetRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-plutus-entities-Asset", ["validate"]);
...
class AssetService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-plutus/gen/edm/api/entities/AssetService.ts/" + entity.Id);
