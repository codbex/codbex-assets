angular.module('page', ["ideUI", "ideView", "entityApi"])
	...
	.controller('PageController', ['$scope', '$http', 'messageHub', 'entityApi', 'Extensions', function ($scope, $http, messageHub, entityApi, Extensions) {
		...
		$http.get("/services/ts/codbex-plutus/gen/edm/api/entities/LocationsService.ts").then(function (response) {
		...
		$http.get("/services/ts/codbex-plutus/gen/edm/api/entities/CategoriesService.ts").then(function (response) {
