...
export class ValuationRepository {
    ...
    public customDataCount(): number {
        const resultSet = query.execute('SELECT COUNT(*) AS COUNT FROM "VALUATION"');
    ...
    private async triggerEvent(data: ValuationEntityEvent | ValuationUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-plutus-entities-Valuation", ["trigger"]);
        ...
        producer.topic("codbex-plutus-entities-Valuation").send(JSON.stringify(data));
    }
}
