...
export class LocationRepository {
    ...
    private async triggerEvent(data: LocationEntityEvent | LocationUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-plutus-entities-Location", ["trigger"]);
        ...
        producer.topic("codbex-plutus-entities-Location").send(JSON.stringify(data));
    }
}
