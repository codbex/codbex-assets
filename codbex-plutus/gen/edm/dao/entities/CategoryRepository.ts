...
export class CategoryRepository {
    ...
    public customDataCount(): number {
        const resultSet = query.execute('SELECT COUNT(*) AS COUNT FROM "CATEGORY"');
    ...
    private async triggerEvent(data: CategoryEntityEvent | CategoryUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-plutus-entities-Category", ["trigger"]);
        ...
        producer.topic("codbex-plutus-entities-Category").send(JSON.stringify(data));
    }
}
