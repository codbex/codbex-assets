...
export class DisposalRepository {
    ...
    public customDataCount(): number {
        const resultSet = query.execute('SELECT COUNT(*) AS COUNT FROM "DISPOSAL"');
    ...
    private async triggerEvent(data: DisposalEntityEvent | DisposalUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-plutus-entities-Disposal", ["trigger"]);
        ...
        producer.topic("codbex-plutus-entities-Disposal").send(JSON.stringify(data));
    }
}
