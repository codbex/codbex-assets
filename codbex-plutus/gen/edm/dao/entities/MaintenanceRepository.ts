...
export class MaintenanceRepository {
    ...
    public customDataCount(): number {
        const resultSet = query.execute('SELECT COUNT(*) AS COUNT FROM "MAINTENANCE"');
    ...
    private async triggerEvent(data: MaintenanceEntityEvent | MaintenanceUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-plutus-entities-Maintenance", ["trigger"]);
        ...
        producer.topic("codbex-plutus-entities-Maintenance").send(JSON.stringify(data));
    }
}
