...
export class MaintenanceRepository {
    ...
    private async triggerEvent(data: MaintenanceEntityEvent | MaintenanceUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-assets-Maintenance-Maintenance", ["trigger"]);
        ...
        producer.topic("codbex-assets-Maintenance-Maintenance").send(JSON.stringify(data));
    }
}
