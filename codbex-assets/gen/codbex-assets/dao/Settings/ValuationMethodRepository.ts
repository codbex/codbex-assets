...
export class ValuationMethodRepository {
    ...
    private async triggerEvent(data: ValuationMethodEntityEvent | ValuationMethodUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-assets-Settings-ValuationMethod", ["trigger"]);
        ...
        producer.topic("codbex-assets-Settings-ValuationMethod").send(JSON.stringify(data));
    }
}
