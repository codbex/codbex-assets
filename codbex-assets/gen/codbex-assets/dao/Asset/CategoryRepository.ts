...
export class CategoryRepository {
    ...
    private async triggerEvent(data: CategoryEntityEvent | CategoryUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-assets-Asset-Category", ["trigger"]);
        ...
        producer.topic("codbex-assets-Asset-Category").send(JSON.stringify(data));
    }
}
