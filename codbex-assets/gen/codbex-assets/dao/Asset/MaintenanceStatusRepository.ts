...
export class MaintenanceStatusRepository {
    ...
    private async triggerEvent(data: MaintenanceStatusEntityEvent | MaintenanceStatusUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-assets-Asset-MaintenanceStatus", ["trigger"]);
        ...
        producer.topic("codbex-assets-Asset-MaintenanceStatus").send(JSON.stringify(data));
    }
}
