...
export class LocationRepository {
    ...
    private async triggerEvent(data: LocationEntityEvent | LocationUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-assets-Asset-Location", ["trigger"]);
        ...
        producer.topic("codbex-assets-Asset-Location").send(JSON.stringify(data));
    }
}
