...
export class MaintenanceStatusRepository {
    ...
    private async triggerEvent(data: MaintenanceStatusEntityEvent | MaintenanceStatusUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-assets-MaintenanceStatus-MaintenanceStatus", ["trigger"]);
        ...
        producer.topic("codbex-assets-MaintenanceStatus-MaintenanceStatus").send(JSON.stringify(data));
    }
}
