...
export class CategoryRepository {
    ...
    public customDataCount(): number {
        const resultSet = query.execute('SELECT COUNT(*) AS COUNT FROM "CODBEX_PLUTUS_CATEGORY"');
    ...
    private async triggerEvent(data: CategoryEntityEvent | CategoryUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-assets-TempCategory-Category", ["trigger"]);
        ...
        producer.topic("codbex-assets-TempCategory-Category").send(JSON.stringify(data));
    }
}
