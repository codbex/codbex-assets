...
export class DisposalMethodRepository {
    ...
    private async triggerEvent(data: DisposalMethodEntityEvent | DisposalMethodUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-assets-DisposalMethod-DisposalMethod", ["trigger"]);
        ...
        producer.topic("codbex-assets-DisposalMethod-DisposalMethod").send(JSON.stringify(data));
    }
}
