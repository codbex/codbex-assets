...
export class DeprecationScheduleRepository {
    ...
    private async triggerEvent(data: DeprecationScheduleEntityEvent | DeprecationScheduleUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-assets-DeprecationSchedule-DeprecationSchedule", ["trigger"]);
        ...
        producer.topic("codbex-assets-DeprecationSchedule-DeprecationSchedule").send(JSON.stringify(data));
    }
}
