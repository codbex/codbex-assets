...
export class ValuationMethodRepository {
    ...
    private async triggerEvent(data: ValuationMethodEntityEvent | ValuationMethodUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-assets-entities-ValuationMethod", ["trigger"]);
        ...
        producer.topic("codbex-assets-entities-ValuationMethod").send(JSON.stringify(data));
    }
}
