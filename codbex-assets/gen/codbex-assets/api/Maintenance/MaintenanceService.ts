...
import { MaintenanceRepository, MaintenanceEntityOptions } from "../../dao/Maintenance/MaintenanceRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-assets-Maintenance-Maintenance", ["validate"]);
...
class MaintenanceService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-assets/gen/codbex-assets/api/Maintenance/MaintenanceService.ts/" + entity.Id);
