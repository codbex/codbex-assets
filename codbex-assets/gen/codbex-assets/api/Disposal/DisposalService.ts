...
class DisposalService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-assets.Disposal.DisposalReadOnly") || user.isInRole("codbex-assets.Disposal.DisposalFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-assets.Disposal.DisposalFullAccess")) {
            throw new ForbiddenError();
        }
    }
