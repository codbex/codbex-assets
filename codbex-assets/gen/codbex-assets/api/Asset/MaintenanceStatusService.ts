...
import { MaintenanceStatusRepository, MaintenanceStatusEntityOptions } from "../../dao/Asset/MaintenanceStatusRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("codbex-assets-Asset-MaintenanceStatus", ["validate"]);
...
class MaintenanceStatusService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-assets/gen/codbex-assets/api/Asset/MaintenanceStatusService.ts/" + entity.Id);
