...
class ValuationService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-assets.Asset.ValuationReadOnly") || user.isInRole("codbex-assets.Asset.ValuationFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-assets.Asset.ValuationFullAccess")) {
            throw new ForbiddenError();
        }
    }
