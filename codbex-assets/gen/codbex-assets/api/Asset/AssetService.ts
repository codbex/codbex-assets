...
class AssetService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-assets.Asset.AssetReadOnly") || user.isInRole("codbex-assets.Asset.AssetFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-assets.Asset.AssetFullAccess")) {
            throw new ForbiddenError();
        }
    }
