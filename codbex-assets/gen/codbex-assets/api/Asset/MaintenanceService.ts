...
class MaintenanceService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-assets.Asset.MaintenanceReadOnly") || user.isInRole("codbex-assets.Asset.MaintenanceFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-assets.Asset.MaintenanceFullAccess")) {
            throw new ForbiddenError();
        }
    }
