angular.module('page', ["ideUI", "ideView", "entityApi"])
	...
	.controller('PageController', ['$scope', '$http', 'messageHub', 'entityApi', 'Extensions', function ($scope, $http, messageHub, entityApi, Extensions) {
		...
		//-----------------Events-------------------//
		messageHub.onDidReceiveMessage("codbex-assets.Asset.MaintenanceStatus.entitySelected", function (msg) {
			resetPagination();
			$scope.selectedMainEntityId = msg.data.selectedMainEntityId;
			$scope.loadPage($scope.dataPage);
		}, true);

		messageHub.onDidReceiveMessage("codbex-assets.Asset.MaintenanceStatus.clearDetails", function (msg) {
		...
		$scope.loadPage = function (pageNumber, filter) {
			let MaintenanceStatus = $scope.selectedMainEntityId;
			...
			filter.$filter.equals.MaintenanceStatus = MaintenanceStatus;
		...
		$scope.createEntity = function () {
			...
			messageHub.showDialogWindow("Maintenance-details", {
				action: "create",
				entity: {},
				selectedMainEntityKey: "MaintenanceStatus",
		...
		$http.get("/services/ts/codbex-assets/gen/codbex-assets/api/Asset/MaintenanceStatusService.ts").then(function (response) {
